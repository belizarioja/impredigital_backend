...
function setFacturacion(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const from = " from t_serviciostipodoc a ";
            const where = " where a.idserviciosmasivo = $1 and a.idtipodocumento = $2 ";
            const resp = yield database_1.pool.query(sql + from + where, [id, idtipodocumento]);
            ...
            const sqlupd = "update t_serviciostipodoc set identificador = " + identificador + ", corelativo = " + corelativo;
            const whereupd = " where idserviciosmasivo = " + id + " and idtipodocumento = " + idtipodocumento;
